...
module "c2-worker1" {
    ...
    guest_vm_name           = "c2-worker1"
    guest_vcpu              = "4"
    guest_memory            = "16384"
    guest_disk0_size        = "40"
    guest_network           = "lab-mgmt"
    guest_ipv4_address      = "192.168.130.114"
...
output "c2-worker1-VM-ip" {
	value = module.c2-worker1.VM-ip
}
output "c2-worker1-VM-guest-ip" {
	value = module.c2-worker1.VM-guest-ip
}
