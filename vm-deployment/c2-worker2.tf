...
module "c2-worker2" {
    ...
    guest_vm_name           = "c2-worker2"
    guest_vcpu              = "4"
    guest_memory            = "16384"
    guest_disk0_size        = "40"
    guest_network           = "lab-mgmt"
    guest_ipv4_address      = "192.168.130.115"
...
output "c2-worker2-VM-ip" {
	value = module.c2-worker2.VM-ip
}
output "c2-worker2-VM-guest-ip" {
	value = module.c2-worker2.VM-guest-ip
}
